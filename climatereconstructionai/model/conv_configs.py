...
def init_enc_conv_configs(conv_factor, enc_dec_layers, pool_layers, start_channels):
    conv_configs = []
    for i in range(enc_dec_layers):
        ...
        conv_config['img_size'] = conv_factor // (2 ** i)
    ...
    for i in range(pool_layers):
        ...
        conv_config['skip_channels'] = 0
        conv_config['img_size'] = conv_factor // (2 ** (enc_dec_layers + i))
        conv_configs.append(conv_config)
