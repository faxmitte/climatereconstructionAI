...
def init_enc_conv_configs(img_size, conv_factor, enc_dec_layers, pool_layers, start_channels):
    conv_configs = []
...
def init_dec_conv_configs(img_size, conv_factor, enc_dec_layers, pool_layers, start_channels, end_channels):
    conv_configs = []
    for i in range(pool_layers):
        conv_config = {}
        conv_config['bn'] = True
